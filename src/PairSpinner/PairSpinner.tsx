export default class PairSpinner {
  ...
  newPairCombinations(allPossibleCombinations: Array<Array<string>>, oldCombinations: Array<Array<string>>): Array<string> {
    const newPairCombinations = allPossibleCombinations.filter(combination => !oldCombinations
    ...
    return newPairCombinations.length === 0 ?
      ...
      newPairCombinations[Math.floor(Math.random() * newPairCombinations.length)];
  }
